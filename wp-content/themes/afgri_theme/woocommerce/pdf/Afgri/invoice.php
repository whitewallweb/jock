...
<table class="head container">
	<tr>
		...
		<td class="shop-info" style="font-size:0.7em;">
			<div class="shop-name"><?php $wpo_wcpdf->shop_name(); ?></div>
                        <br/>
...
<div id="footer"  style="text-align: left; ">
    <table>
        <tr>
            <td width="70%" style="font-size: 0.7em;vertical-align: bottom;">
                <?php $wpo_wcpdf->footer(); ?>
            </td>
             <td width="30%">
                  <img src="<?php echo $_SERVER["DOCUMENT_ROOT"]."/wp-content/plugins/jock/libs/images/invoice_footer.jpg"?>"> </img>
            </td>
        </tr>
    </table>
</div><!-- #letter-footer -->
